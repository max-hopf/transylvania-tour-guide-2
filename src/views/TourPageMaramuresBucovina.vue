<template>
  ...
  description="Experience the best of both Regions with our combined tour, where traditional village life meets stunning painted monasteries."
  imageName="maramures-bucovina-title-img"
/>
